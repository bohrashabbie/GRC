...
is on_hand at the single default online-sellable location, so the simple UX and
the full inventory module can never disagree about how much stock exists.
"""
