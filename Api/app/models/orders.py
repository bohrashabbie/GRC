...
class Order(Base, TimestampMixin):
    ...
    discount_total: Mapped[float] = mapped_column(Numeric(12, 3), nullable=False, default=0)
    shipping_total: Mapped[float] = mapped_column(Numeric(12, 3), nullable=False, default=0)
    tax_total: Mapped[float] = mapped_column(Numeric(12, 3), nullable=False, default=0)
    grand_total: Mapped[float] = mapped_column(Numeric(12, 3), nullable=False, default=0)
...
class OrderItem(Base, TimestampMixin):
    ...
    unit_price_snapshot: Mapped[float] = mapped_column(Numeric(12, 3), nullable=False)
...
class Shipment(Base, TimestampMixin):
    ...
    cost: Mapped[float | None] = mapped_column(Numeric(12, 3), nullable=True)
